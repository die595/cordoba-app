...
async function classifyArticles(articles) {
    ...
    `;
        ...
        return articles.map((original)=>{
            const aiData = classifiedData.find((a)=>a.id === original.id);
            return {
                ...original,
...
async function fetchAllNews() {
    ...
    if (deduped.length > 0) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$classify$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["classifyArticles"])(deduped).then((classified)=>{
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseAdmin$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabaseAdmin"].from("articles").upsert(updates, {
                onConflict: "id"
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10bbl69._.js.map